...
export const Floor = () => {
  ...
  //     setFloors(response.data.response); // Correctly set the floors state
  //   } catch (error) {
  //     console.error(error);
  //   }
  // };
  ...
  //   try {
  //     await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/setup/create-floor`, { name: floorName, description: floorDescription });
  //     fetchFloors();
  //     closeModal();
  //   } catch (error) {
  //     console.error(error);
  ...
  //   try {
  //     await axios.patch(`${import.meta.env.VITE_APP_BASE_URL}/setup/update-floor/${currentFloorId}`, { name: floorName, description: floorDescription });
  //     fetchFloors();
  //     closeModal();
  //   } catch (error) {
  //     console.error(error);
  ...
  //   try {
  //     const response = await axios.get(`${import.meta.env.VITE_APP_BASE_URL}/setup/getFloorById/${id}`);
  //     setFloorName(response.data.response.name); // Access the floor name from response object
  //     setFloorDescription(response.data.response.description); // Access the floor description from response object
  ...
  //   try {
  //     await axios.delete(`${import.meta.env.VITE_APP_BASE_URL}/setup/delete-floor/${id}`);
  //     fetchFloors();
  //   } catch (error) {
  //     console.error(error);
  //   }
    ...
    <div className='md:flex-[0.85] '>
      <div className=" bg-white    border border-gray-300">
        ...
        <div className="px-3 py-1 flex  bg-white justify-between  ">
          <h2 className="text-xl">Floor List</h2>
      ...
      {isShowForm && <ShowPopAddForm setIsShowForm={setIsShowForm} heading={"Floor"} />}

      {isShowEditForm && <ShowPopEditForm setIsShowEditForm={setIsShowEditForm} heading={"Floor"}/>}
