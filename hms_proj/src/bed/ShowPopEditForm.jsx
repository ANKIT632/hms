    ...
    return (
        ...
        <div className="fixed inset-0 flex items-top justify-center z-50 ">
            ...
            <div className="bg-white  shadow-lg z-10 max-md:w-[70%] max-xs:w-[90%] md:w-[30%]  h-fit mt-5 rounded-sm ">
                ...
                <div className="flex bg-blue-400 text-white justify-center p-2 text-lg font-semibold justify-between items-center"><p >{"Edit "+heading}</p><ImCross className="text-xs  right-4 top-4 hover:text-gray-600 cursor-pointer" onClick={() => setIsShowEditForm((pre) => !pre)} /></div>
