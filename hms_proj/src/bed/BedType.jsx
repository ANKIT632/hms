...
const BedGroup = () => {
  ...
  // const [bedGroupFloor, setBedGroupFloor] = useState('');
  // const [bedGroupDescription, setBedGroupDescription] = useState('');
  // const [isEditing, setIsEditing] = useState(false);
  // const [currentBedGroupId, setCurrentBedGroupId] = useState(null);
  ...
  //   try {
  //     const response = await axios.get(`${import.meta.env.VITE_APP_BASE_URL}/setup/get-floors`);
  //     setFloors(response.data.response);
  //   } catch (error) {
  //     console.error(error);
  //   }
  // };
  ...
  //   try {
  //     await axios.post(`${import.meta.env.VITE_APP_BASE_URL}/setup/create-bedGroup`, { name: bedGroupName, floor: bedGroupFloor, description: bedGroupDescription });
  //     fetchBedGroups();
  //     closeModal();
  //   } catch (error) {
  //     console.error(error);
  ...
  //   try {
  //     await axios.patch(`${import.meta.env.VITE_APP_BASE_URL}/setup/update-bedGroup/${currentBedGroupId}`, { name: bedGroupName, floor: bedGroupFloor, description: bedGroupDescription });
  //     fetchBedGroups();
  //     closeModal();
  //   } catch (error) {
  //     console.error(error);
  ...
  //   try {
  //     const response = await axios.get(`${import.meta.env.VITE_APP_BASE_URL}/setup/getbedGroupById/${id}`);
  //     setBedGroupName(response.data.response.name);
  //     setBedGroupFloor(response.data.response.floor._id); // Adjust this line
  //     setBedGroupDescription(response.data.response.description);
  //     setCurrentBedGroupId(id);
  //     setIsEditing(true);
  //     setModalIsOpen(true);
  //   } catch (error) {
  //     console.error(error);
  ...
  //   try {
  //     await axios.delete(`${import.meta.env.VITE_APP_BASE_URL}/setup/delete-bedGroup/${id}`);
  //     fetchBedGroups();
  //   } catch (error) {
  //     console.error(error);
  //   }
    ...
    <div className='md:flex-[0.85] '>
      <div className=" bg-white    border border-gray-300">
        ...
        <div className="px-3 py-1 flex bg-white justify-between  ">
          <h2 className="text-xl">Bed Type List</h2>
      ...
      {isShowForm && <ShowPopAddForm setIsShowForm={setIsShowForm} heading={"Bed Type"} />}

      {isShowEditForm && <ShowPopEditForm setIsShowEditForm={setIsShowEditForm} heading={"Bed Type"}/>}
