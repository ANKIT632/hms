...
function CommonShowtableData({ data,setIsShowPaitentForm }) {
  ...
  return (
    <>
      ...
      {isShowPaitentDetails && <ShowPopAddForm setIsShowPaitentDetails ={setIsShowPaitentDetails} setIsShowPaitentForm={setIsShowPaitentForm}  data={data}/>}
    </>
  )
}

export default CommonShowtableData;