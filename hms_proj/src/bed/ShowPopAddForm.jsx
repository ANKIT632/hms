...
function ShowPopAddForm({ setIsShowForm, heading }) {
    ...
    return (
        ...
        <div className="fixed inset-0 flex items-top justify-center z-50 ">
            ...
            <div className="bg-white  shadow-lg z-10 max-md:w-[70%] max-xs:w-[90%] md:w-[30%]  h-fit mt-5 rounded-sm ">

                <div className="flex bg-blue-400 text-white justify-between items-center p-2 text-lg font-semibold "><p >{"Add "+heading}</p><ImCross className="text-xs  right-4 top-4 hover:text-gray-600 cursor-pointer" onClick={() => setIsShowForm((pre) => !pre)} /></div>
                <form className="px-5 py-2 flex flex-col gap-3 ">
                 ...
                 { heading==="Bed Group" &&  <div className="flex flex-col gap-0.5">
                        <label htmlFor="floor" className="text-sm flex font-semibold">
                            Floor <p className="text-red-500 pl-1 pb-1"> *</p>
                        </label>
                        <select name="floor" className="w-full outline-none border border-gray-300 focus:border-blue-400 pl-2 p-1 text-sm">
                    ...
                    {(heading==='Floor' || heading==="Bed Group") && <div className="flex flex-col gap-0.5">
                        <label htmlFor="title" className="text-sm flex font-semibold">
                    ...
                    {heading==='Bed' && <div className="flex flex-col gap-0.5">
                        <label htmlFor="bedType" className="text-sm flex font-semibold">
                            Bed Type <p className="text-red-500 pl-1 pb-1"> *</p>
                        </label>
                    ...
                    {heading==='Bed' &&  <div className="flex flex-col gap-0.5">
                        <label htmlFor="bedType" className="text-sm flex font-semibold">
                            Bed Group <p className="text-red-500 pl-1 pb-1"> *</p>
                        </label>
                        <select name="bedType" className="w-full outline-none border border-gray-300 focus:border-blue-400 pl-2 p-1 text-sm">
                            <option>Select</option>
                        </select>
