  ...
  return (
    <div className=" bg-slate-100 absolute h-full w-full">
      <div className=" bg-white m-4 flex-1 border border-gray-300">
        ...
        <div className="px-4 py-1.5 flex max-xs:flex-col bg-white justify-between  ">
          <h2 className="text-lg ">Disabled Patient List</h2>

          <div className="ml-2 mt-2  text-white  w-fit">

        

            <div className="flex  items-center  bg-blue-500 rounded-sm px-2  py-1 gap-0.5  hover:bg-btn-hover active:bg-gray-600 cursor-pointer h-6 " onClick={() => navigateHandler("/patient")}>
