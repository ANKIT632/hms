...
function PopUpAddPatientForm({setIsShowPaitentEditForm,data}) {
    ...
    <div className="fixed inset-0 flex items-center justify-center  z-50   ">
      ...
      <div className="bg-white  shadow-lg z-10 max-sm:w-[94%] max-md:w-[75%] md:w-[700px] lg:w-[850px] absolute-5 max-md:h-[99vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center px-4 bg-blue-400  h-10 text-white ">
          <p className="font-bold text-md">Patient Details</p>
          <div className="  text-xs hover:text-gray-500 cursor-pointer active:text-gray-600" onClick={()=>setIsShowPaitentEditForm((pre)=>!pre)}><ImCross /></div>
        </div>
