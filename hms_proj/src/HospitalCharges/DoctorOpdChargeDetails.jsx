...
function DoctorOpdChargeDetails({ setIsShowDetails }) {
    ...
    return (
        ...
        <div className="fixed inset-0 flex items-top justify-center z-50 ">
            ...
            <div className="relative bg-white shadow-lg z-10 max-sm:w-[94%] max-md:w-[80%] md:w-[900px] h-fit mt-5 rounded-sm overflow-y-auto max-h-[90vh]  ">
                <div className="flex bg-blue-400 text-white justify-between items-center p-2 text-lg font-semibold "><p >Charge Details</p><ImCross className="text-xs  right-4 top-4 hover:text-gray-600 cursor-pointer" onClick={() => setIsShowDetails((pre) => !pre)} /></div>

                {/* div1 */}    

                    <ul  className="p-4 text-sm grid grid-cols-2 xs:gap-4 max-xs:grid-cols-1">
                        <li className="flex justify-between "><p className="font-semibold"> Doctor</p><p>		Doctor Victim Blame</p>
                        </li>
...
export default DoctorOpdChargeDetails;